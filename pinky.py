...
def validate_input(data):
    ...
    try:
        ...
        validations = [
            ...
            (40 <= trestbps <= 200, "Blood pressure must be between 40 and 200"),
            (0 <= chol <= 350, "Cholesterol must be between 0 and 350"),
            (20 <= thalach <= 250, "Max heart rate must be between 20 and 250"),
        ]
...
if __name__ == '__main__':
    try:
        ...
        load_or_train_model()
        logger.info("Backend ready! Starting server on http://127.0.0.1:5000")
